...
Revision ID: 717420eb850b
Revises: 
Create Date: 2025-09-26 13:46:38.194688
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_base_tokens_id'), 'base_tokens', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_base_tokens_id'), table_name='base_tokens')
    op.drop_table('base_tokens')
